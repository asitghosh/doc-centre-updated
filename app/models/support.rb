class Support < Page
  ...
  attr_accessor :active_admin_requested_event_support

  searchkick merge_mappings: true, mappings: mapping, index_name: "support_#{Rails.env}"
  def headline
    "Support Guides"
  end
  ...
  def generate_permalink
    ...
    self.update_column(:permalink, "/help-support/#{urls.join('/')}")
  end
